$(function(){init();});if(typeof document.attachEvent!='undefined'){document.attachEvent('onmousemove',moveMouse);document.attachEvent('onclick',checkMove);}
else{document.addEventListener('mousemove',moveMouse,false);document.addEventListener('click',checkMove,false);}
var oDv=document.createElement("div");var dvHdr=document.createElement("div");var dvBdy=document.createElement("div");var windowlock,boxMove,fixposx,fixposy,lockX,lockY,fixx,fixy,ox,oy,boxLeft,boxRight,boxTop,boxBottom,evt,mouseX,mouseY,boxOpen,totalScrollTop,totalScrollLeft;boxOpen=false;ox=10;oy=10;lockX=0;lockY=0;function init(){oDv.appendChild(dvHdr);oDv.appendChild(dvBdy);oDv.style.position="absolute";oDv.style.zIndex="99";oDv.style.visibility='hidden';oDv.style.maxWidth='375px';document.body.appendChild(oDv);}
function defHdrStyle(){dvHdr.innerHTML='<img  style="vertical-align:middle"  src="info.gif">&nbsp;&nbsp;'+dvHdr.innerHTML;dvHdr.style.fontWeight='bold';dvHdr.style.fontFamily='arial';dvHdr.style.border='1px solid #333333';dvHdr.style.padding='5px';dvHdr.style.fontSize='14px';dvHdr.style.color='#CCCCCC';dvHdr.style.background='#370000';}
function defBdyStyle(){dvBdy.style.borderBottom='1px solid #333333';dvBdy.style.borderLeft='1px solid #333333';dvBdy.style.borderRight='1px solid #333333';dvBdy.style.fontFamily='arial';dvBdy.style.fontSize='11px';dvBdy.style.padding='5px';dvBdy.style.color='#1B4966';dvBdy.style.background='#FFFFFF';}
